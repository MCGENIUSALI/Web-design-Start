...
export function CTASection() {
  ...
  return (
    <section id="contacts" className="py-24 bg-gradient-to-br from-primary/10 via-background to-secondary/10 relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <h2 className="text-4xl lg:text-6xl font-bold text-foreground text-balance">
            ...
            <span className="text-primary">vision digitale</span> ?
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            ...
            <div className="flex items-center gap-6">
              ...
              >
                <Phone size={20} />
                <span onClick={() => window.open(whatsappLink, "_blank")}>
                  085 06 74 579
                </span>
              </a>
            </div>
